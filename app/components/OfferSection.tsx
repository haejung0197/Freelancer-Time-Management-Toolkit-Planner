...
export default function OfferSection() {
  return (
    <section className="py-12 text-center px-4 space-y-[28px]">
      <h2 className="text-[25px] sm:text-[32px] font-bold text-black ">
      ...
      <button className="w-full bg-black text-white p-2  xs:p-4  rounded-md xs:rounded-lg transition hover:scale-105 duration-300 cursor-pointer max-w-md mx-auto ">
